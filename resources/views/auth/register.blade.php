                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        @csrf
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name" autofocu placeholder="Enter your last name" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <!-- <a class="btn btn-primary btn-block" type="submit" >Create Account</a> -->
                                                    <button type="submit" class="btn btn-primary">
                                                    Create Account
                                                    </button>
                                                </div>
